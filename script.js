...
const letterDescriptionText = document.querySelector(
  ".playing-display__description"
);
...
const changeLetterColour = (currentLetter, playerAnswer) => {
  ...
  if (
    playerAnswer !== letterBeingPlayed.getAttribute("answer") &&
    playerAnswer !== "pasapalabra"
  ) {
